...
export const MARKET_TYPE = {
  ...
  'PURCHASE': 'PURCHASE',
  'SOLD': 'SOLD',
  'NFTSWAP_CREATE_BUNDLE': 'NFTSWAP_CREATE_BUNDLE',
  'NFTSWAP_CREATE_OFFER': 'NFTSWAP_CREATE_OFFER',
  'NFTSWAP_CANCEL_OFFER': 'NFTSWAP_CANCEL_OFFER',
  'NFTSWAP_REFUSE_OFFER': 'NFTSWAP_REFUSE_OFFER',
  'NFTSWAP_ACCEPT_OFFER': 'NFTSWAP_ACCEPT_OFFER',
  'NFTSWAP_CANCEL_BUNDLE': 'NFTSWAP_CANCEL_BUNDLE',
}

export const ASSET_STATE = {
  'MARKET_LISTED': 'MARKET_LISTED',
  'SWAP_LISTED': 'SWAP_LISTED',
