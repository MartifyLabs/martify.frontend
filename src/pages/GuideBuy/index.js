  ...
  return (
    <div className="section container">
      ...
      <div className="content">
        ...
        <p>To purchase ADA, you will need to join a centralized exchange such as <a href="https://www.coinbase.com/" target="_blank">Coinbase</a>. Coinbase is an exchange where one can purchase, buy, sell, convert, and send cryptocurrency. In a way, Coinbase is like how one would interact with the stock market. If you are familiar with stock trading platforms, you will be extremely comfortable in Coinbase.</p>
        <p>Coinbase is quick to set up, but you may need a few days before everything is approved. Coinbase needs <a href="https://help.coinbase.com/en/coinbase/getting-started/getting-started-with-coinbase/id-doc-verification" target="_blank">Identity Documentation</a> such as a passport or driver’s license and then approval of a <a href="https://help.coinbase.com/en/coinbase/getting-started#add-a-payment-method" target="_blank">Payment Method</a>.</p>
