    ...
    <div className="section container">
      ...
      <div className="content">
        ...
        <ol>
          ...
          <li><b>Setup a cryptocurrency wallet</b>: Signup for a "Non-custodial" wallet like Nami Wallet, GeroWallet or ccvault.io, which is where you can store and control your cryptocurrency and digital assets. Transfer your ADA coins from Coinbase to your wallet, which gives you the control to purchase NFTs across the various NFT marketplaces.</li>
          <li><b>Connect your wallet (Nami Wallet, GeroWallet, ccvault.io...) on Martify and add collateral</b>: That is easy!</li>
        ...
        <p>To purchase ADA, you will need to join a centralized exchange such as <a href="https://www.coinbase.com/" target="_blank" rel="noreferrer">Coinbase</a>. Coinbase is an exchange where one can purchase, buy, sell, convert, and send cryptocurrency. In a way, Coinbase is like how one would interact with the stock market. If you are familiar with stock trading platforms, you will be extremely comfortable in Coinbase.</p>
        <p>Coinbase is quick to set up, but you may need a few days before everything is approved. Coinbase needs <a href="https://help.coinbase.com/en/coinbase/getting-started/getting-started-with-coinbase/id-doc-verification" target="_blank" rel="noreferrer">Identity Documentation</a> such as a passport or driver’s license and then approval of a <a href="https://help.coinbase.com/en/coinbase/getting-started#add-a-payment-method" target="_blank" rel="noreferrer">Payment Method</a>.</p>

        <h2>Step 2: Setup a cryptocurrency wallet</h2>
        {/* <h3>Overview: Step 2</h3> */}
        <ol>
          <li><b>Download a cryptocurrency wallet</b>:  Download one of the browser extension which will be your own personal "digital wallet" : <br/>
          <a href="https://namiwallet.io/" target="_blank" rel="noreferrer">Nami Wallet</a> (Chrome, Brave and Edge compatible), <br/>
          <a href="https://gerowallet.io/" target="_blank" rel="noreferrer">GeroWallet</a> (Chrome, Brave and Edge compatible) or <br/>
          <a href="https://ccvault.io/" target="_blank" rel="noreferrer">ccvault.io</a> (Chrome, Brave, Edge and Opera compatible). <br/>
          With your "digital wallet", you get to store and use your cryptocurrency and digital assets (like NFTs).</li>
          <li><b>Setup your wallet</b>: Write down and confirm your seed phrase, and input a new password.</li>
          <li><b>Fund your wallet</b>: Transfer your ADA from Coinbase to your wallet.</li>
        </ol>
        ...
        <p>Go to <a href="https://namiwallet.io/" target="_blank" rel="noreferrer">Nami Wallet</a>, <a href="https://gerowallet.io/" target="_blank" rel="noreferrer">GeroWallet</a> or <a href="https://ccvault.io/" target="_blank" rel="noreferrer">ccvault</a> or  to download the browser extension. <b>Important</b>: To avoid any scam, we recommend you to visit their official page and then select the desired browser type to install the application. If you click on Chrome, you will be automatically taken to the Google Chrome web store. Click "Add extension" and it will be downloaded and installed. Once installed, you will be able to view the wallet icon (a blue "N" for Nami Wallet) in the top right corner of your browser.</p>
        ...
        <p>Now that you have your cryptocurrency wallet, you will want to transfer your funds out of Coinbase. You need to get your wallet address, by clicking on the "Receive" button, you can copy your Cardano address. If you are using Coinbase on your smartphone, you can also scan the QR code from the Coinbase application. <b>Important</b>: you must send your ADA via the Cardano network. It would take a few minutes to get your ADA transfer from Coinbase to your Nami Wallet.</p>

        <h2>Step 3: Connect your wallet on Martify and add collateral</h2>
